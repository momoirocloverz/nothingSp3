    ...
    <div>
        ...
        <el-form ref="form" :model="form" label-width="110px" label-position="left" class="formSearchMarginTop">
            ...
            <el-form-item label="关键字：" class="formSearchMargin ">
                <el-input class="rant-input inputWidth keyWFormParent" v-model="form.nameAlias" placeholder="输入零工姓名"></el-input>
...
//      this.getsettlement()
    ...
    methods: {
      ...
      view(row) {
        this.$router.push({ name: "workerDetail", params: { id: row.id } });
      },
      getsettlement(){
