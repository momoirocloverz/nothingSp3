<template>
    <div>
        <el-table class="table-outline" :data="tableData" empty-text="暂无相关信息">
            <el-table-column prop="updatedAt" :formatter="createdAt" :show-overflow-tooltip="true" label="支付时间"
            ...
            <el-table-column prop="" :show-overflow-tooltip="true" label="订单详情" align="center" min-width="">
                <template v-slot="scope">
                    <el-button size="small" type="text" @click="routeToDetail( scope.row)">查看发放结果</el-button>
                </template>
