    ...
    <el-form ref="form" :model="form" label-width="100px" labelPosition="left">
      ...
      <el-form-item label="类型：" class="formSearchMargin formSearchMarginTop">
        <el-radio-group class="radio-search" v-model="form.note">
          ...
          <el-radio label="普通充值">普通充值</el-radio>
          <el-radio label="普通充值手续费">普通充值手续费</el-radio>
          <el-radio label="外包费用">外包费用</el-radio>
          <el-radio label="外包手续费">外包手续费</el-radio>
          <el-radio label="外包费用充值手续费">外包费用充值手续费</el-radio>
          <el-radio label="外包费用充值">外包费用充值</el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item label="经理人：" class="formSearchMargin">
        <el-radio-group class="radio-search" v-model="form.mangers">
          <el-radio label="">全部经理人</el-radio>
          <el-radio label="1">万才物流</el-radio>
          <el-radio label="2">经理人A</el-radio>
          <el-radio label="3">经理人B</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-form>
    <div>
      ...
      <el-table class="table-outline" :data="tableData" empty-text="暂无相关信息">
        ...
        <el-table-column prop="userName" label="名称" show-overflow-tooltip align="center" min-width="150px"></el-table-column>
  ...
  methods: {
    ...
    getList() {
      let param = {
        ...
        queryType: 2,  // 2:客户  3:项目经理  4:经纪人  5:零工
      }
