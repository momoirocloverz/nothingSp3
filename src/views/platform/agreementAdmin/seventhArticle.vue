<template>
    <div class="seventhArticleCon">        
        <div class="editorCon">
            <quill-editor v-model="content"   ref="firstQuillEditor"  :options="editorOption"   @blur="onEditorBlur($event)"  @focus="onEditorFocus($event)"   @ready="onEditorReady($event)">
            </quill-editor>
        </div>
        <div class="btnCon">
