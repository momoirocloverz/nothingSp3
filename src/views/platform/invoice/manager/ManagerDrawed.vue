    ...
    <div>
      ...
      <div class="splitLine"></div>
        <el-table class="table-outline" :data="tableData" empty-text="暂无相关信息">
            ...
            <!-- <el-table-column prop="invoiceToCustomerName" :show-overflow-tooltip="true" label="项目经理公司名称" align="center" min-width="120">
            </el-table-column> -->
            ...
            <el-table-column prop="invoiceNumber" :show-overflow-tooltip="true" label="发票号码" align="center" min-width="140">
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getList(){
                ...
                pageSize: 20,
                applyUserType:2,
                invoiceName:this.form.select == 1 ? this.form.keyWord : '',
                applyUserName:this.form.select == 2 ? this.form.keyWord : '',
                };
                this.$api
